...
<div class="form-group">
    <label class="col-md-3 control-label">Moto/Tagline</label>

    <div class="col-md-8">
        <input type="text" name="tagline" class="form-control" placeholder="Moto/Tagline" value="<?php echo $konfigurasi->tagline ?>" required>
    </div>
</div>
