<p class="pull-right">
    <div class="btn-group pull-right">
        <a href="<?php echo base_url('admin/transaksi') ?>" title="cetak" class="btn btn-success btn-sm">
            <i class="fa fa-backward"></i> Kembali
        </a>
    </div>
    <div class="btn-group pull-right">
        <a href="<?php echo base_url('admin/transaksi/cetak/' . $header_transaksi->kode_transaksi) ?>" target="_blank" title="cetak" class="btn btn-info btn-sm">
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>: <?php echo $header_transaksi->kurir ?></td>
        </tr>
        <tr>
            <td>Tanggal Bayar</td>
