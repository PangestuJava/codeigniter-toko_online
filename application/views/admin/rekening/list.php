        ...
        foreach ($rekening as $rekening) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url('admin/rekening/delete/' . $rekening->id_rekening) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Ingin Menghapus Data ini?')"><i class="fa fa-trash-0"></i> Hapus</a>
                </td>
            </tr>
        <?php $no++;
        } ?>
