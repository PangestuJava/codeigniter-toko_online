        ...
        foreach ($produk as $produk) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url('admin/produk/delete/' . $produk->id_produk) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Ingin Menghapus Data ini?')"><i class="fa fa-trash-0"></i> Hapus</a>
                </td>
            </tr>
        <?php $no++;
        } ?>
