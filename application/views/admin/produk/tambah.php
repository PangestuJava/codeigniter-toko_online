...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="berat" class="form-control" placeholder="Berat Produk" value="<?php echo set_value('berat') ?>" required number_format>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <select name="status_produk" class="form-control">
            ...
            <option value="Darft">Simpan Sebagai Draft</option>
        </select>
    </div>
</div>
