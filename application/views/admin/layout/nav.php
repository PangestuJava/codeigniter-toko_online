...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- Menu Dashboard -->
            <li>
                <a href="<?php echo base_url('admin/dasbor') ?>"><i class="fa fa-dashboard text-aqua"></i>
                    <span>DASHBOARD</span>
                </a>
            </li>
            ...
            <!-- Menu Transaksi -->
            <li>
                <a href="<?php echo base_url('admin/transaksi') ?>"><i class="fa fa-check text-aqua"></i>
                    <span>TRANSAKSI</span>
                </a>
            </li>
            ...
            <!-- Menu Rekening -->
            <li>
                <a href="<?php echo base_url('admin/rekening') ?>"><i class="fa fa-dollar text-aqua"></i>
            ...
            <!-- Menu Transaksi -->
            <li>
                <a href="<?php echo base_url('admin/kritik') ?>"><i class="fa fa-icon text-aqua"></i>
