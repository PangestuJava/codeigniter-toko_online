    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-9 col-lg-9 p-b-50">
                ...
                <hr>
                <p>Berikut Detail Belanja Anda</p>
                    ...
                    <table class="table">
                        <tbody>
                                    ...
                                    <select name="id_rekening" class="form-control">
                                        <?php foreach ($rekening as $rekening) { ?>
                                            <option value="<?php echo $rekening->id_rekening ?>" <?php if ($header_transaksi->id_rekening == $rekening->id_rekening) {
                                                ...
                                                (No. Rekening: <?php echo $rekening->nomor_rekening ?> a/n <?php echo $rekening->nama_pemilik ?>)
                                            </option>
                                        <?php } ?>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" name="rekening_pembayaran" class="form-control" placeholder="Nomor Rekening" value="<?php echo $header_transaksi->rekening_pembayaran ?>">
                                    <small>Misal : 2423242323</small>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-info btn-lg" type="reset" name="submit"><i class="fa fa-times"></i>
                                            Reset
                                        </button>
                                    </div>
                                </td>
