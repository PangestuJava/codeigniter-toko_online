...
$nav_footer = $this->konfigurasi_model->nav();
?>
...
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
    <div class="flex-w p-b-90">
        ...
        <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
            ...
            <ul>
                <?php foreach ($nav_footer as $nav_footer) { ?>
                    <li class="p-b-9">
                        <a href="<?php echo base_url('produk/kategori/' . $nav_footer->slug_kategori) ?>" class="s-text7">
                            <?php echo $nav_footer->nama_kategori ?>
                        </a>
                    </li>
                <?php } ?>
            </ul>
    ...
    <div class="t-center p-l-15 p-r-15">
        ...
        <div class="t-center s-text8 p-t-20">
            Copyright © by <i class="fa fa-heart-o" aria-hidden="true"></i>Republic.Id
        </div>
    </div>
</footer>
