...
$nav          = $this->konfigurasi_model->nav();
$nav_mobile   = $this->konfigurasi_model->nav();
?>
                                ...
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        <img src="<?php echo base_url(
                                                        'assets/upload/image/thumbs/' . $produk_mobile->gambar
                ...
                <ul class="sub-menu">
                    <?php foreach ($nav_mobile as $nav_mobile) { ?>
                        <li><a href="<?php echo base_url('produk/kategori/' . $nav_mobile->slug_kategori) ?>">
                                <?php echo $nav_mobile->nama_kategori ?></a></li>
                    <?php } ?>
                </ul>
            </li>
